...
//                   <button  class="login-submit">
//                     <a id="emailButton" class="fas fa-chevron-right" href="">Enviar</a >
//                   </button>
//                 </form>      
//                 </div>
...
// resetPassword(email)
// })
// // divHome.querySelector('#register').addEventListener('click', () => {
// //   location.pathname = "/src/index.html/register";
// // })
...
// divHome.addEventListener('submit', (e) => {
//   e.preventDefault();
//   const email= document.querySelector('#emailId').value;
//   resetPassword(email);
...
// });
// creo un evento click, creo la constante con el id, y su valor
divHome.querySelector('#emailButton').addEventListener('click', (e) =>{
e.preventDefault();
const email= document.querySelector("#emailId").value;
resetPassword(email)
})
